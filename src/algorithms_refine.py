...
from utils import log as _uilog
...
def refine_alignment_multi_roi(
    ref_gray:np.ndarray, tgt_gray:np.ndarray, cx, cy, r,
    ...
    rois = _select_rois(energy, mask, r, k=n_rois, box=roi_size, ref_img=ref_gray)
    ...
    for sc, x, y, bw, bh in rois:
        ...
        bmin, bmax = 30, 220
        ref_block8 = ref_gray[y:y + bh, x:x + bw]
